...
travis-install:
	...
	wget https://github.com/phpredis/phpredis/archive/develop.zip -O phpredis-develop.zip && unzip phpredis-develop.zip
	cd phpredis-develop/ && phpize && ./configure && make && make install
